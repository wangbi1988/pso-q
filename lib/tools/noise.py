...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 12 10:02:50 2021
...
class ActionNoise(ABC):
    ...
    def reset(self, eps = 1) -> None:
        """
        call end of episode reset for the noise
        """
        self.eps = int(np.random.rand() <= eps)
...
class NormalActionNoise(ActionNoise):
    ...
    def __call__(self) -> np.ndarray:
        return self.eps * np.random.normal(self._mu, self._sigma)
